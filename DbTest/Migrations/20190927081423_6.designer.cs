...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DbTest.Stepper.Model.Workflow.BasicTaskAcl", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DbTest.Stepper.Model.Workflow.BasicTask", b =>
                {
                    b.HasOne("DbTest.Model.RLS.SecurityIdentity", "ApprovedBySecurityIdentity")
                        .WithMany("AssignedTasks")
                        .HasForeignKey("ApprovedBySecurityIdentityID");

                    b.HasOne("DbTest.Model.RLS.SecurityGroup")
                        .WithMany("AssignedTasks")
                        .HasForeignKey("SecurityGroupId");
                });
