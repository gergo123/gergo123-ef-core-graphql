...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DbTest.Stepper.Model.RLS.SecurityObject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DbTest.Stepper.Model.Workflow.BasicTask", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long>("ApprovedBySecurityObjectID");
                    ...
                    b.HasIndex("ApprovedBySecurityObjectID");
            ...
            modelBuilder.Entity("DbTest.Stepper.Model.Workflow.TestEntityModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DbTest.Model.RLS.SecurityGroup", b =>
                {
                    b.HasBaseType("DbTest.Stepper.Model.RLS.SecurityObject");
            ...
            modelBuilder.Entity("DbTest.Stepper.Model.Workflow.BasicTask", b =>
                {
                    b.HasOne("DbTest.Stepper.Model.RLS.SecurityObject", "ApprovedBySecurityObject")
                        .WithMany()
                        .HasForeignKey("ApprovedBySecurityObjectID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DbTest.Stepper.Model.RLS.SecurityObject", "SecurityObject")
