...
using Test.Db.Interface.Stepper;
...
namespace Test.Db.Stepper
{
    public class StateManagger : IStateManagger
    {
        ...
        /// <summary>
        /// Itt a már egyedi paraméterekkel inicializált StateChange objektum kerül be, itt már nem kell a DI problémával foglalkozni.
        /// Ez az a verzió ahol a change objektum implementálja az IProducesTask interface-t.
        /// </summary>
    ...
    public interface IStateManagger
    {
        ...
        /// <summary>
        /// Feladat státusz állítás
        /// </summary>
        /// <param name="task"></param>
        /// <param name="securityObject">Aktuális jóváhagyó user</param>
        /// <param name="newStatus">A feladat új státusza</param>
